...
namespace Repository.Migrations
{
    ...
    [Migration("20240105232207_RefactoringOptionsReletionship5555")]
    partial class RefactoringOptionsReletionship5555
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Project", b =>
                {
                    ...
                    b.Property<string>("ManagementSystem")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.User", b =>
                {
                    ...
                    b.HasIndex("OwnCompanyId")
                        .IsUnique()
                        .HasFilter("[OwnCompanyId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Company", "OwnCompany")
                        .WithOne("Owner")
                        .HasForeignKey("Domain.Models.User", "OwnCompanyId");
