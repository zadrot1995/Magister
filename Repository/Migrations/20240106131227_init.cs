        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionContext = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ManagementSystemId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectStages = table.Column<int>(type: "int", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ManagementSystem = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyOption", x => new { x.CategoryId, x.CategoryId1 });
                    table.ForeignKey(
                        name: "FK_CompanyOption_Companies_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyOption_Options_CategoryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyOption1", x => new { x.TypeId, x.TypeId1 });
                    table.ForeignKey(
                        name: "FK_CompanyOption1_Companies_TypeId",
                        column: x => x.TypeId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyOption1_Options_TypeId1",
                        column: x => x.TypeId1,
                        principalTable: "Options",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ManagementSystemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ManagementSystemId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyOption2", x => new { x.ManagementSystemId, x.ManagementSystemId1 });
                    table.ForeignKey(
                        name: "FK_CompanyOption2_Companies_ManagementSystemId",
                        column: x => x.ManagementSystemId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyOption2_Options_ManagementSystemId1",
                        column: x => x.ManagementSystemId1,
                        principalTable: "Options",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskStageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tasks_TaskStages_TaskStageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyOption_CategoryId1",
                table: "CompanyOption",
                column: "CategoryId1");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyOption1_TypeId1",
                table: "CompanyOption1",
                column: "TypeId1");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyOption2_ManagementSystemId1",
                table: "CompanyOption2",
                column: "ManagementSystemId1");
